...
Die Positionen steuerst du hier:

```html
style="top: 30%; left: 18%;"
```

Damit platzierst du die Sterne exakt dort, wo die Bücher im Regal stehen.

---

# Gratis veröffentlichen (empfohlen)

## GitHub Pages

Am einfachsten und gratis.
...
Dann erhältst du eine öffentliche URL.
